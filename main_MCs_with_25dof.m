...
%              170,172,174,176,178,180,182,184,186,188,190,192,194,196,198,200] ; % 100 element
    ...
    rom.config = 'Twenty_five_dofs_selected' ;
...
err_uncon = relError(post_processing.pdf.plt_pdf.Uncon_full(1,:,end-1),post_processing.pdf.plt_pdf.Uncon_rom(1,:,end-1),'display',false) ; 
err_con = relError(post_processing.pdf.plt_pdf.Ucon_full(1,:,end-1),post_processing.pdf.plt_pdf.Ucon_rom(1,:,end-1),'display',false) ; 
